...
"""
では、始めていきたいと思います。前提として、私は人工知能(またはそれに近い物)を実際に作ってみてそれを自分の経験値として身に付けるのが趣旨だと思ってください。あなた(CHATGPT)はあくまで私の補助という事を覚えておいてください。
まず、すべての段階(土台(環境) → ランダム検証 → 小規模学習 → 本命手法)の最初の項目(土台(環境))からやります。
"""